...
[RealtimeModel]
public partial class BlarpScoreModel {
    [RealtimeProperty(1, true, true)]
    private int _score;
}
/* ----- Begin Normal Autogenerated Code ----- */
public partial class BlarpScoreModel : IModel {
    // Properties
    public int score {
    ...
    // Events
    public delegate void ScoreDidChange(BlarpScoreModel model, int value);
